        ...
        <div className="pt-2 sm:pt-4 flex flex-col justify-center text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 mt-2">
            ...
            <div className="flex items-center gap-4 text-gray-500 dark:text-gray-400">
              ...
              {/* Discord */}
              <a href="https://github.com/ybunnn-dev" className="hover:text-header_text dark:hover:text-white transition-colors" aria-label="Discord">
              ...
              {/* Facebook (Manual SVG) */}
              <a href="https://www.facebook.com/johnivan.belaro" className="hover:text-[#1877F2] dark:hover:text-white transition-colors" aria-label="Facebook">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
