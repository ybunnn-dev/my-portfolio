    ...
    >
      <div className="grid w-full max-w-9xl grid-cols-1 gap-8 md:grid-cols-2 lg:gap-32">
        ...
        <div className="flex items-center justify-center">
          <div className="relative aspect-square w-full max-w-lg rounded-lg border border-white/30 bg-white/5 backdrop-blur-sm ">
        ...
        <div className="flex flex-col justify-center text-center lg:text-left">
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-white lg:text-7xl 2xl:text-8xl">
            Hi, I’m Ivan
          </h1>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-6">
            ...
            <div className="flex items-center gap-5 text-white">
              <a href="https://github.com/ybunnn-dev" target="_blank" className="transition-transform hover:scale-110 hover:text-gray-300">
